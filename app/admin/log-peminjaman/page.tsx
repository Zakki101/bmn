...
import { FolderDown, Plus, ArrowDownUp } from "lucide-react";
...
export default function LogPeminjamanPage() {
  ...
  const handleDownloadExcel = () => {
    ...
    saveAs(blob, "log_data_peminjaman.xlsx");
  };

  return (
    <div className="space-y-2">
      <div className="flex items-center justify-between">
        <h1 className="pt-0 pb-0 text-[25px] font-bold">Log Peminjaman</h1>
        {/* export + tambah data */}
            ...
            <table className="w-full border-collapse">
              ...
              <tbody className="text-[14px]">
                {paginatedData.length > 0 ? (
                  ...
                  <tr>
                      <td colSpan={16} className="border p-4 text-center bg-gray-100">
