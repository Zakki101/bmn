  ...
  return (
    <input
      ...
      className={cn(
        ...
        "focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] hover:bg-accent hover:text-accent-foreground focus-visible:outline-none disabled:bg-transparent disabled:text-muted data-[state=open]:bg-transparent",
